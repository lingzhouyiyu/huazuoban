...
Page({
  ...
  getGoodsById: function (goodsId) {
    ...
    Model.getGoodsById_points(goodsId, data => {
      console.log('商品详情');
  ...
  gotoconfirmOrder: function () {
    ...
    //将下单数据存进全局变量aloneGoodsDatapoint
    app.globalData.aloneGoodsDatapoint.buyCount = buyCount;
    app.globalData.aloneGoodsDatapoint.chosedAttrId = chosedAttrId;
    app.globalData.aloneGoodsDatapoint.goodsId = goodsId;
    app.globalData.aloneGoodsDatapoint.openId = openId;
    app.globalData.aloneGoodsDatapoint.price = price;
    app.globalData.aloneGoodsDatapoint.chooseProduct = chooseProduct;
    app.globalData.aloneGoodsDatapoint.goodsData = goodsData;
    app.globalData.aloneGoodsDatapoint.jiaprice = jiaprice;
    app.globalData.aloneGoodsDatapoint.jiagougoodsData = jiagougoodsData;
    app.globalData.aloneGoodsDatapoint.zengsonggoodsData = zengsonggoodsData;
    app.globalData.aloneGoodsDatapoint.addBuyId = addBuyId;
    app.globalData.aloneGoodsDatapoint.giftId = giftId;
    app.globalData.aloneGoodsDatapoint.addBuyTitle = addBuyTitle;
    app.globalData.aloneGoodsDatapoint.giftTitle = giftTitle;
    app.globalData.aloneGoodsDatapoint.getTimeTitle = getTimeTitle;
    app.globalData.aloneGoodsDatapoint.getTimeValue = getTimeValue;
    app.globalData.aloneGoodsDatapoint.needpoint = this.data.goodsData.points;//所需积分
    app.globalData.aloneGoodsDatapoint.oldPrice = this.data.oldPrice;//商品原价
    // console.log(app.globalData.aloneGoodsDatapoint);
    // return;
    this.setData({
      querenBtnStatus: false
    })
    wx.navigateTo({
      url: '../confirmOrderalonepoint/confirmOrderalonepoint',
    })
  },
  // 优惠
  selectoption: function (e) {
